...
-- Add foreign key with SET NULL on delete (allows audit logs to remain after user deletion)
ALTER TABLE public.audit_logs
  ADD CONSTRAINT audit_logs_user_id_fkey 
  FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE SET NULL;

-- Verify all other tables referencing users have proper CASCADE or SET NULL
-- profiles
...
-- Update delete_user_safe to insert audit BEFORE deleting user
