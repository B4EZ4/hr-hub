...
ALTER TABLE IF EXISTS public.auth_audit DROP CONSTRAINT IF EXISTS auth_audit_user_id_fkey;
...
-- Update delete_user_safe function to handle cascading deletes properly
